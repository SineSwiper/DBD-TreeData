...
eval { $v .= pmver('DBD::AnyData::Statement','any version') };
eval { $v .= pmver('DBD::AnyData::Table','any version') };
eval { $v .= pmver('DBD::AnyData::db','any version') };
eval { $v .= pmver('DBD::AnyData::dr','any version') };
eval { $v .= pmver('DBD::AnyData::st','any version') };
